...
class TestView(TestCase):
    ...
    def test_update_post(self):
        ...
        response = self.client.post(
            update_post_url,
            {
                ...
                'content': '안녕 Post Form 페이지를 수정합니다',
        ...
        self.assertIn('안녕 Post Form 페이지를 수정합니다', main_area.text)
    ...
    def test_comment_update(self):
        ...
        self.assertEqual('Edit Comment - Bolg', soup.title.text)
        update_comment_form = soup.find('div', id='comment-form')
        # comment_textarea = update_comment_form.find('textarea', id='id_content')
        # self.assertIn(self.comment_001.comment, comment_textarea.text)
